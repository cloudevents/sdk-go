...
var (
	...
	// data codec methods.
	LatencyMs = stats.Float64("cloudevents.io/sdk-go/datacodec/nop/latency", "The latency in milliseconds for the CloudEvents nop data codec methods.", "ms")
)

var (
	// LatencyView is an OpenCensus view that shows data codec json method latency.
	LatencyView = &view.View{
		Name:        "datacodec/nop/latency",
		Measure:     LatencyMs,
		Description: "The distribution of latency inside of the nop data codec for CloudEvents.",
...
func (o observed) TraceName() string {
	switch o {
	case reportEncode:
		return "datacodec/nop/encode"
	case reportDecode:
		return "datacodec/nop/decode"
	default:
		return "datacodec/nop/unknown"
	}
}
