...
func (v CodecV02) obsEncode(ctx context.Context, e event.Event, encoding Encoding) (transport.Message, error) {
	switch encoding {
	case Default:
		fallthrough
	case BinaryV02:
...
func (v CodecV02) obsDecode(ctx context.Context, msg transport.Message) (*event.Event, error) {
...
func (v CodecV02) encodeBinary(ctx context.Context, e event.Event) (transport.Message, error) {
...
func (v CodecV02) toHeaders(ec *event.EventContextV02) (http.Header, error) {
	h := http.Header{}
...
func (v CodecV02) decodeBinary(ctx context.Context, msg transport.Message) (*event.Event, error) {
	m, ok := msg.(*Message)
	if !ok {
...
func (v CodecV02) fromHeaders(h http.Header) (event.EventContextV02, error) {
	// Normalize headers.
	for k, v := range h {
