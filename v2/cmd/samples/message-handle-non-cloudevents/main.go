...
// In order to run this test, look at documentation in https://github.com/cloudevents/sdk-go/blob/master/v2/cmd/samples/kafka/README.md
func main() {
	...
	go func() {
		for {
			...
			if inputMessage.ReadEncoding() == binding.EncodingUnknown {
				...
				event.SetSource("https://github.com/cloudevents/sdk-go/v2/cmd/samples/kafka/sender")
