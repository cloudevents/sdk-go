...
// This function *doesn't* guarantee that the returned binding.Message is always a kafka_segmentio.Message instance
func NewMessageFromConsumerMessage(cm *kafka.Message) *Message {
